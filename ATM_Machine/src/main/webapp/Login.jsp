...
<link href="https://fonts.googleapis.com/css2?family=Oswald&display=swap" rel="stylesheet">
    ...
    font-family: 'Oswald', sans-serif;
        ...
        .loki::before{
            content: "";
    background-image: url('src/main/webapp/WEB-INF/rupixen-com-Q59HmzK38eQ-unsplash.jpg');
...
<body>
    ...
    <div class="loki">
       ...
       <a href="saving_account.jsp" id="saving"> saving account </a>
       <a href="current_account.jsp" id="current"> current account </a>
