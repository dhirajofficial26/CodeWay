...
<body>
<form action="RandomNumber.jsp" method="post">
    <header class="header">
        <div class="left"> 
    ...
    <img src="https://media.giphy.com/media/l2JhtHeyE3QEJJNT2/giphy.gif" class="cube" alt="">

   <div id="info">
    <h3>Guess the number in between 1 to 6</h3>
    <input id="text" type="text" name="number" placeholder="Enter your number">
</div> 
<%
    ...
    int num = random.nextInt(max - min + 1) + min; // Adjust the range

    System.out.println("Random number"+num); 

    session.setAttribute("generatedNumber", num);
%>

    <button type="submit" id="play" class="btn">submit</button>
</form>
